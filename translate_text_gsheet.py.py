...
with engine.connect() as conn:
    try:
        ...
        gc = gspread.service_account(filename= 'E:\Projects\Snowflake_Project\Scripts\Python_scripts\snowflake-project-426201-f952b03f305b.json')

        loop_counter = 0
        chunk_size = 100
        file_name = 'OTODOM_ANALYSIS_'
        user_email = '123sid567@gmail.com'
